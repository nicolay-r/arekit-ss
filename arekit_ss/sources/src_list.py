DATA_PROVIDER_PIPELINES = {
    "ruattitudes": {
        ...
        "entity_parser": "arekit_ss.sources.ruattitudes.utils.entity.parser.RuAttitudesTextEntitiesParser",
    ...
    "rusentrel": {
        ...
        "entity_parser": "arekit_ss.core.source.brat.entities.parser.BratTextEntitiesParser",
        "label_scaler": "arekit_ss.sources.labels.scaler.PosNegNeuRelationsLabelScaler",
        "label_formatter": "arekit_ss.sources.labels.formatter.PosNegNeuLabelsFormatter",
        "src_lang": "ru"
    },
    ...
    "nerel": {
        ...
        "label_formatter": "arekit_ss.sources.nerel.labels_fmt.NerelAnyLabelFormatter",
        "src_lang": "ru"
    },
    "nerel-bio": {
        ...
        "label_formatter": "arekit_ss.sources.nerel_bio.labels_fmt.NerelBioAnyLabelFormatter",
        "src_lang": "ru"
    }
}
